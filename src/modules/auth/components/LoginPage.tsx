...
export default function LoginPage() {
  ...
  return (
    <main className="ds-bg flex items-center justify-center px-4">


      {/* ── card ── */}
      <div
        className="w-full max-w-md rounded-2xl ds-bg-form ds-border-form px-10 py-12 ds-shadow-sm"
      >
        ...
        <Text size="base" color="gray-200" className="text-center mb-8">
          {t("login")}
        </Text>
