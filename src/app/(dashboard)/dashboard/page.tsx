...
//   return (
//     <Link href={href} className="text-xs font-semibold hover:underline" style={{ color: "var(--color-text-brand)" }}>
//       ↗ Show All
//     </Link>
//     // <a
//     //   href={href}
...
//           <Card title="Latest Subscriber Requests" action={<ShowAll  href="/company-requests"/>}>
//             <div className="flex flex-col gap-3">
//               {requests.map((r) => (
//                 <div
//                   key={r.id}
